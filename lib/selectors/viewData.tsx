 ...
 *
 */
function column (data = [], series = {}, results = _results, col_name = '') {
 ...
 */
function column_tally (data = [], series = {}, results = _results, col_name = '') {
  const idx = colIndex(results, col_name)
...
/* */
function round (data = [], series = {}, results = _results) {
  return data.map(d => {
...
function sum (data = [], series = {}, results = _results) {
...
// general row funcs
//
function sum_rows (data = [], series = {}, results = _results) {
  return [Object.assign({
...
function max_value (data = [], series = {}, results = _results, col_name = '') {
  const idx = colIndex(results, col_name)
  return [Object.assign({
...
function min_value (data = [], series = {}, results = _results, col_name = '') {
  const idx = colIndex(results, col_name)
  return [Object.assign({
...
function sum_value (data = [], series = {}, results = _results, col_name = '') {
  const idx = colIndex(results, col_name)
  return [Object.assign({
...
function avg_value (data = [], series = {}, results = _results, col_name = '') {
  const idx = colIndex(results, col_name)
  return [Object.assign({
...
function colIndex (results = _results, col_name = '') {
